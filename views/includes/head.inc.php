 ...
 <!-- Bootstrap Core CSS -->
    ...
    <!-- Custom CSS -->
    <link href="views/resource/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="views/resource/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="views/resource/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
